 ...
 * =====================================================================================
 *
 *       Filename:  fig17_14.cpp
 *
 *    Description:  Fig. 17.14 - This program reads a random-access file
 *                  sequentially, updates data previously written to the file,
 *                  creates data to be placed in the file, and deletes data
 *                  previously stored in the file.
 *
 *        Version:  1.0
 *        Created:  06/01/17 17:49:29
 *       Revision:  none
 *       Compiler:  g++
 *
